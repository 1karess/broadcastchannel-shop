...
- **购物站**：`你的用户名.github.io/broadcastchannel-shop`（GitHub Pages，origin: github.io）
...
4. 等待部署完成，访问 `https://你的用户名.github.io/broadcastchannel-shop/`

## 测试链接

- 新闻站：https://site-alpha-alpha.vercel.app
- 购物站：https://你的用户名.github.io/broadcastchannel-shop/
